...
function loadQuestion() {
  // NOTE: we are calling our django server to fetch quiz data
  fetch("http://localhost:8000/proctorpoint/api/quizes") // Replace with your actual URL
    .then((response) => {
      if (!response.ok) {
...
function submitQuiz() {
  ...
  scoreTextEl.textContent = `Your final score is: ${score} out of ${totalQuestions} (${(
